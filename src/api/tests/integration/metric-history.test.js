...
//                 });
//         });
//         it('should get all metric history with query customer', () => {
//             return request(app)
//                 .get('/v1/metric-history')
//                 .set('Authorization', token)
...
//     describe('POST /v1/metric-history', () => {
//         it('should create a new metric history when request is ok', () => {
//             return request(app)
//                 .post('/v1/metric-history')
//                 .set('Authorization', token)
//                 .send(newRecord)
//                 .expect('Content-Type', /json/)
//                 .expect(httpStatus.OK)
